...
function Hex5M2BaseAI()
    ...
    Hex5M2Base:InitializeDifficultyTables(aiBrain, 'M2_Hex5_Main_Base', 'M2_Hex5_Base_Marker', 150, {M2_Hex5_Main_Base = 100})
