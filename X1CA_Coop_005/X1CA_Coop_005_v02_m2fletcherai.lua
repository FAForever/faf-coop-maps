    ...
    opai = FletcherBase:AddOpAI('Fatboy_1',
        {
            ...
            PlatoonAIFunction = {'/maps/X1CA_Coop_005_v02/X1CA_Coop_005_v02_m2fletcherai.lua', 'FletcherBaseAmphibiousAttacks'},
            MaxAssist = 15,
            Retry = true,
        }
    )
...
-- ========================================================================
	...
	local builder = {
		...
		PlatoonAIFunction = {'/maps/X1CA_Coop_005_v02/X1CA_Coop_005_v02_m2fletcherai.lua', 'FletcherLandPlatoonThread'},
    }
...
function M2FletcherBaseAirAttacks()
    ...
    for i = 1, 2 do
        ...
        opai = FletcherBase:AddOpAI('AirAttacks', 'M2_AirAttack1' .. i,
            {
                MasterPlatoonFunction = {'/maps/X1CA_Coop_005_v02/X1CA_Coop_005_v02_m2fletcherai.lua', 'FletcherAirPlatoonThread'},
                Priority = 100,
            }
        )
