...
ScenarioInfo = {
	...
	version = 3,
    size = {1024, 1024},
    map = '/maps/X1CA_Coop_005_v03/X1CA_Coop_005_v03.scmap',
    save = '/maps/X1CA_Coop_005_v03/X1CA_Coop_005_v03_save.lua',
    script = '/maps/X1CA_Coop_005_v03/X1CA_Coop_005_v03_script.lua',
    ...
    Configurations = {
        ['standard'] = {
            teams = {
                { name = 'FFA', armies = {'Player','Fletcher','Hex5','QAI','Aeon','UEF','Order','Brackman','Coop1','Coop2','Coop3'} },
            },
            customprops = {
            },
        },
