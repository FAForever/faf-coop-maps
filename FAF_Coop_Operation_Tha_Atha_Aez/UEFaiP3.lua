...
function P3UEFbase1AI()
    ...
    P3Ubase1:InitializeDifficultyTables(aiBrain, 'UEFP3base1', 'P3UB1MK', 90, {P3UBase1 = 100})
...
function P3UB1LandAttacks()
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
        {{'HumanPlayers'}, 35, (categories.STRUCTURE * categories.DEFENSE) - categories.TECH1}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
            PatrolChains = {'P3UB1Landattack1', 'P3UB1Landattack2'}
...
function P3UB1NavalAttacks()
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
        {{'HumanPlayers'}, trigger[Difficulty], categories.T2SUBMARINE + categories.xss0304}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
            PatrolChains = {'P3UB1Navalattack1', 'P3UB1Navalattack2'}
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
        {{'HumanPlayers'}, trigger[Difficulty], categories.NAVAL * categories.MOBILE * categories.TECH3 - categories.xss0304}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
            PatrolChains = {'P3UB1Navalattack1', 'P3UB1Navalattack2'}
...
function P3UEFbase2AI()
    local aiBrain = ArmyBrains[UEF]--[[@as CampaignAIBrain]]
    P3Ubase2:InitializeDifficultyTables(aiBrain, 'UEFP3base2', 'P3UB2MK', 80, {P3UBase2 = 100})
...
function P3UB2AirAttacks()
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
        {'SeraphimAlly2', 10, categories.AIR * categories.MOBILE}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
            PatrolChains = {'P3UB2Landattack1', 'P3UB2Landattack2', 'P3UB2Landattack3'}
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
        {{'HumanPlayers'}, 1, categories.xsb2305 + categories.uab2305}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
...
function P3UB2LandAttacks()
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
        {'SeraphimAlly2', 10, categories.LAND * categories.MOBILE - categories.ENGINEER}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
            PatrolChains = {'P3UB2Landattack1', 'P3UB2Landattack2', 'P3UB2Landattack3'}
...
function P3UEFbase3AI()
    local aiBrain = ArmyBrains[UEF]--[[@as CampaignAIBrain]]
    P3Ubase3:InitializeDifficultyTables(aiBrain, 'UEFP3base3', 'P3UB3MK', 80, {P3UBase3 = 100})
...
function P3UB3LandAttacks()
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
        {'SeraphimAlly2', 12, categories.LAND * categories.MOBILE - categories.ENGINEER}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
            PatrolChains = {'P3UB3Landattack1', 'P3UB3Landattack2', 'P3UB3Landattack3'}
...
function P3UB3AirAttacks()
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
        {'SeraphimAlly2', 15, categories.AIR * categories.MOBILE}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
            PatrolChains = {'P3UB3Landattack1', 'P3UB3Landattack2', 'P3UB3Landattack3'}
