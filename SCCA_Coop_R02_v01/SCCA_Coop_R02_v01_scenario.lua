...
ScenarioInfo = {
    ...
    preview = '',
    size = {512, 512},
    map = '/maps/SCCA_Coop_R02_v01/SCCA_Coop_R02_v01.scmap',
    save = '/maps/SCCA_Coop_R02_v01/SCCA_Coop_R02_v01_save.lua',
    script = '/maps/SCCA_Coop_R02_v01/SCCA_Coop_R02_v01_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
