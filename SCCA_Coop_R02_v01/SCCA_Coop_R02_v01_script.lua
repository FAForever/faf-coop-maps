...
local OpStrings = import('/maps/SCCA_Coop_R02_v01/SCCA_Coop_R02_v01_strings.lua')
local OpEditorFns = import ('/maps/SCCA_Coop_R02_v01/SCCA_Coop_R02_v01_EditorFunctions.lua')
