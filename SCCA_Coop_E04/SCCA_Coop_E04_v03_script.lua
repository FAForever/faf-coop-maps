#****************************************************************************
#**
#**  File     :  /maps/SCCA_Coop_E04_v03/SCCA_Coop_E04_v03_script.lua
#**  Author(s):  Matt Mahon
#**
#**  Summary  :
#**
...
local OpStrings = import ('/maps/SCCA_Coop_E04_v03/SCCA_Coop_E04_v03_strings.lua')
local EditorFunctions = import('/maps/SCCA_Coop_E04_v03/SCCA_Coop_E04_v03_EditorFunctions.lua')
...
function M1StartAirAttackTimer ()
    #Called from SCCA_Coop_E04_v03_EditorFunctions
...
function WinGame()
    ...
    --LOG ('debug matt: comleted mission '..'SCCA_Coop_E04_v03'..ScenarioInfo.Options.Difficulty,secondaries)
...
#    ScenarioFramework.EndOperation('SCCA_Coop_E04_v03', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end
