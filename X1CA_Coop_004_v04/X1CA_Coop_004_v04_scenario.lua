...
ScenarioInfo = {
    ...
    preview = '',
    size = {1024, 1024},
    map = '/maps/X1CA_Coop_004_v04/X1CA_Coop_004_v04.scmap',
    save = '/maps/X1CA_Coop_004_v04/X1CA_Coop_004_v04_save.lua',
    script = '/maps/X1CA_Coop_004_v04/X1CA_Coop_004_v04_script.lua',
