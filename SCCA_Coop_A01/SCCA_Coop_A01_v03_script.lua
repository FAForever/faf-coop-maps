-- ****************************************************************************
-- **
-- **  File     :  /maps/SCCA_Coop_A01_v03/SCCA_Coop_A01_v03_script.lua
-- **  Author(s):  Greg
-- **
-- **  Summary  :
-- **
...
local OpStrings   = import('/maps/SCCA_Coop_A01_v03/SCCA_Coop_A01_v03_Strings.lua')
...
-- ScenarioFramework.EndOperation('SCCA_Coop_A01_v03', true, ScenarioInfo.Options.Difficulty, true, true)
-- end
