-- ****************************************************************************
-- **
-- **  File     :  /maps/SCCA_Coop_A01_v03/SCCA_Coop_A01_v03_operation.lua
...
opID = 'SCCA_Coop_A01_v03'						-- should always be in the form 'SCCA_' + faction letter + 2-digit op num, e.g. SCCA_E01
