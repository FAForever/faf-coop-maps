-- ****************************************************************************
-- **
-- **  File     : /maps/X1CA_Coop_001/X1CA_Coop_001_m2orderai.lua
...
function OrderM2AirNorthBaseAirAttacks()
    ...
    if Difficulty >= 3 then
        opai = OrderM2AirNorthBase:AddOpAI('AirAttacks', 'M2_AirNorthAirAttack3' ,
            {
                MasterPlatoonFunction = {SPAIFileName, 'PatrolThread'},
                PlatoonData = {
                    PatrolChain = 'Order_M2_Town_AirPatrol_Chain',
        ...
        opai:SetChildQuantity('StratBombers', 2)
        opai:SetLockingStyle('None')
    end
...
function OrderM2LandSouthBaseLandAttacks()
    ...
    -- sends [heavy bots]
    opai = OrderM2LandSouthBase:AddOpAI('BasicLandAttack', 'M2_LandSouthLandAttack3',
        {
            PlatoonData = {
                PatrolChain = 'Order_M2_TownAttack_Chain',
            },
