-- ****************************************************************************
-- **
-- **  File     :  /maps/SCCA_Coop_A04/SCCA_Coop_A04_v04_operation.lua
...
opID = 'SCCA_Coop_A04'                        -- should always be in the form 'SCCA_' + faction letter + 2-digit op num, e.g. SCCA_E01
