#****************************************************************************
#**
#**  File     :  /maps/SCCA_Coop_R04_v01/SCCA_Coop_R04_v01_script.lua
...
local OpStrings = import ('/maps/SCCA_Coop_R04_v01/SCCA_Coop_R04_v01_strings.lua')
...
function LoseGame()
    WaitSeconds(5)
    ScenarioFramework.EndOperation( 'SCCA_Coop_R04_v01', false, ScenarioInfo.Options.Difficulty, false, false, false )
end
...
function WinGame()
    ...
    ScenarioFramework.EndOperation( 'SCCA_Coop_R04_v01', true, ScenarioInfo.Options.Difficulty, true, secondary ) #, bonus )
end

function OnCtrlF4()
    ScenarioFramework.EndOperation( 'SCCA_Coop_R04_v01', true, ScenarioInfo.Options.Difficulty, false, false, false )
end
...
#    ScenarioFramework.EndOperation('SCCA_Coop_R04_v01', true, ScenarioInfo.Options.Difficulty, true, true, true)
#end
#
