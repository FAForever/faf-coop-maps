-- ****************************************************************************
-- **
-- **  File     :  /maps/SCCA_Coop_R04/SCCA_Coop_R04_v01_script.lua
...
local OpStrings = import ('/maps/SCCA_Coop_R04/SCCA_Coop_R04_v01_strings.lua')
...
function OnCtrlF4()
    ScenarioFramework.EndOperation( 'SCCA_Coop_R04', true, ScenarioInfo.Options.Difficulty, false, false, false )
end
...
-- ScenarioFramework.EndOperation('SCCA_Coop_R04', true, ScenarioInfo.Options.Difficulty, true, true, true)
-- end
--
