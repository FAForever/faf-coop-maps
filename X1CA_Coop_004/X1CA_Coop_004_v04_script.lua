-- ****************************************************************************
-- **
-- **  File     :  /maps/X1CA_Coop_004_v04/X1CA_Coop_004_v04_script.lua
-- **  Author(s):  Jessica St. Croix
-- **
-- **  Summary  : Main mission flow script for X1CA_Coop_004_v04
-- **
-- **  Copyright 2007 Gas Powered Games, Inc.  All rights reserved.
-- ****************************************************************************
local Behaviors = import('/lua/ai/opai/OpBehaviors.lua')
local Cinematics = import('/lua/cinematics.lua')
local M1SeraphimAI = import('/maps/X1CA_Coop_004_v04/X1CA_Coop_004_v04_m1seraphimai.lua')
local M2DostyaAI = import('/maps/X1CA_Coop_004_v04/X1CA_Coop_004_v04_m2dostyaai.lua')
local M2SeraphimAI = import('/maps/X1CA_Coop_004_v04/X1CA_Coop_004_v04_m2seraphimai.lua')
local M3SeraphimAI = import('/maps/X1CA_Coop_004_v04/X1CA_Coop_004_v04_m3seraphimai.lua')
local Objectives = import('/lua/ScenarioFramework.lua').Objectives
local OpStrings = import('/maps/X1CA_Coop_004_v04/X1CA_Coop_004_v04_strings.lua')
...
-- Taunt Managers
-- --------------
local OumEoshiTM = TauntManager.CreateTauntManager('OumEoshiTM', '/maps/X1CA_Coop_004_v04/X1CA_Coop_004_v04_Strings.lua')
local Hex5TM = TauntManager.CreateTauntManager('Hex5TM', '/maps/X1CA_Coop_004_v04/X1CA_Coop_004_v04_Strings.lua')
...
-- ---------------
function OnShiftF3()
    ScenarioFramework.EndOperation('X1CA_Coop_004_v04', true, Difficulty, true, true, true)
end
...
function OnShiftF5()
    ...
    LOG('******************************')
    LOG('Num Dostya units: ', repr(GetArmyUnitCostTotal(Dostya)))
    LOG('Num Dostya structure shields: ', table.getn(ArmyBrains[Dostya]:GetListOfUnits(categories.SHIELD * categories.STRUCTURE, false)))
    LOG('Num Dostya mobile shields: ', table.getn(ArmyBrains[Dostya]:GetListOfUnits(categories.ual0307 + categories.uel0307 + categories.url0306 + categories.xsl0307, false)))
    LOG('******************************')
end
