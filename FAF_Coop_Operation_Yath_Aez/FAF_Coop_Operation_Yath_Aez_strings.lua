...
IntroP3 = {
    {text = '[Overlord HQ]: We have pin pointed one of the Jammers in your operational area.', vid = 'X06_Seth-Iavow_M03_03997.sfd', bank = 'JJ_VO2', cue = 'Intro3_1', faction = 'Seraphim'},
    {text = '[Overlord HQ]: It\'s being defended by an Aeon and Cybran base, the Aeon base is the main target, but you can clear the Cybran if needed.', vid = 'X06_Seth-Iavow_M03_03997.sfd', bank = 'JJ_VO2', cue = 'Intro3_2', faction = 'Seraphim'},
    {text = '[Overlord HQ]: You don\'t have much time Commander enemies out side of your operational range are sending large attack waves at your base, destroy the jammer quicky. HQ out.', vid = 'X06_Seth-Iavow_M03_03997.sfd', bank = 'JJ_VO2', cue = 'Intro3_3', faction = 'Seraphim'},
}
...
RevealP1  = {
    {text = '[Fredrick]:  Another Seraphim? You will soon join your alien buddy in Hell!', vid = 'Graham.sfd', bank = 'JJ_VO2', cue = 'RevealP1', faction = 'UEF'},
}

TAUNT1P1 = {
    {text = '[Fredrick]: I will make you suffer you alien bastard!', vid = 'Graham.sfd', bank = 'JJ_VO2', cue = 'TAUNT1P1', faction = 'UEF'},
}

TAUNT2P1 = {
    {text = '[Fredrick]: Every unit you lose brings me one step closer to victory!', vid = 'Graham.sfd', bank = 'JJ_VO2', cue = 'TAUNT2P1', faction = 'UEF'},
}

TAUNT3P1 = {
    {text = '[Fredrick]: I can rebuild those structures faster than you can destroy them.', vid = 'Graham.sfd', bank = 'JJ_VO2', cue = 'TAUNT3P1', faction = 'UEF'},
}
...
TAUNT3P2 = {
    {text = '[Fredrick]: You think your threatening me you alien bastard?! We\'re just getting started!', vid = 'Graham.sfd', bank = 'JJ_VO2', cue = 'TAUNT3P2', faction = 'UEF'},
}
