...
function P2C1base3AI()
    ...
    C1P2Base3:InitializeDifficultyTables(ArmyBrains[Cybran1], 'P2Cybran1Base3', 'P2C1B3MK', 50, {P2C1base3 = 100})
    C1P2Base3:StartNonZeroBase({{8,11,14}, {6,8,8}})
    C1P2Base3:SetActive('AirScouting', true)
	...
	P2C1B3Landattacks1()
	 ...
	 ForkThread(
        function()
            WaitSeconds(1)
            C1P2Base3:AddBuildGroup('P2C1base3EX_D' .. Difficulty, 900, false)
        end
     )
...
function P2C2base1AI()
    ...
    C2P2Base1:InitializeDifficultyTables(ArmyBrains[Cybran2], 'P2Cybran2Base1', 'P2C2B1MK', 70, {P2C2base1 = 100})
...
function P2C2base2AI()
    ...
    C2P2Base2.MaximumConstructionEngineers = 4
...
function P2C1B2Navalattacks1()
    ...
    Builder = {
       ...
       PlatoonAIFunction = {SPAIFileName, 'PatrolThread'},     
       PlatoonData = {
           PatrolChain = 'P2C1B2NavalAttack4'
       },
    }
    ArmyBrains[Cybran1]:PBMAddPlatoon( Builder )
...
function P2C1B3Landattacks1()
    ...
    local Temp = {
       ...
       { 'url0203', 1, 8, 'Attack', 'GrowthFormation' },     
    }
    local Builder = {
...
function P2C2B1Airattacks1()
	...
	Temp = {
       'P2C2B1AAttackTemp2',
       'NoPlan',
       { 'ura0203', 1, 14, 'Attack', 'GrowthFormation' },       
    }
    Builder = {
