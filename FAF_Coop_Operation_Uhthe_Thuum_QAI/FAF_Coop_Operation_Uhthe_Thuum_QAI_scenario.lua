...
ScenarioInfo = {
    ...
    description = 'QAI survived and needs our help to reupload himself into the Quantum network, you will gate in and support him in any way you can. He alone has such vast processing power he is vital to our struggle against the Humans.',
    type = 'campaign_coop',
    starts = true,
    preview = '',
    size = {1024, 1024},
    ...
    Configurations = {
        ['standard'] = {
            teams = {
                { name = 'FFA', armies = {'Cybran1','QAI','Nodes','Cybran2','Player1','Player2','Player4','Player3',} },
            },
            customprops = {
            },
