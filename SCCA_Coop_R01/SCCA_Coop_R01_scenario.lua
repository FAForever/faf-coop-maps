version = 3
ScenarioInfo = {
    name = '<LOC OPNAME_R01>Cybran Mission 1 - Liberation',
    description = '<LOC SCCA_R01_description>All of the Symbionts on Theban 2 have been enslaved by the UEF\'s loyalty programming. We have initiated a wideband broadcast of the Symbiont Liberation Matrix; by the time we arrive, our brothers and sisters will be free and ready to evacuate.\nUnfortunately, the Aeon have also set their sights on Theban 2 and have launched an offensive against local UEF forces. Defeat the Aeon and UEF armies in your sector in order to free the Symbionts. I will engage the primary UEF commander.',
    type = 'campaign_coop',
    starts = true,
    preview = '',
