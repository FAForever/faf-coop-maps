-- ****************************************************************************
-- **
-- **  File     :  /maps/SCCA_Coop_R01/SCCA_Coop_R01_v01_operation.lua
...
opID = 'SCCA_Coop_R01'					-- should always be in the form 'SCCA_' + faction letter + 2-digit op num, e.g. SCCA_E01
