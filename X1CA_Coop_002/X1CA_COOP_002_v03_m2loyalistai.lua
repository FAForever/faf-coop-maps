...
function LoyalistM2EastBaseAirAttacks()
	...
	local builder = {
		...
		PlatoonAIFunction = {'/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_m2loyalistai.lua', 'LoyalistM2EastAirAttacksAI'},
    }
...
function LoyalistM2WestBaseLandAttacks()
    ...
    for i = 1, 2 do
        opai = LoyalistM2WestBase:AddOpAI('BasicLandAttack', 'M2_LandAttackWest_' .. i,
            {
                MasterPlatoonFunction = {'/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_m2loyalistai.lua', 'LoyalistM2WestLandAttacksAI'},
            }
        )
