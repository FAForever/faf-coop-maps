...
function LoyalistM1MainBaseAirAttacks()
    ...
    for i = 1, 2 do
        opai = LoyalistM1MainBase:AddOpAI('AirAttacks', 'M1_AirAttack1_' .. i,
            {
                MasterPlatoonFunction = {'/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_m1loyalistai.lua', 'LoyalistM1MainAirAttacksAI'},
                Priority = 100,
            }
        )
	...
	local builder = {
		...
		PlatoonAIFunction = {'/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_m1loyalistai.lua', 'LoyalistM1MainAirAttacksAI'},
		BuildCondition = {
...
function LoyalistM1MainBaseLandAttacks()
    ...
    opai = LoyalistM1MainBase:AddOpAI('BasicLandAttack', 'M1_BasicLandAttack',
        {
            MasterPlatoonFunction = {'/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_m1loyalistai.lua', 'LoyalistM1MainLandAttacksAI'},
            Priority = 110,
        }
    )
