-- ****************************************************************************
-- **
-- **  File     :  /maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_script.lua
-- **  Author(s):  Jessica St. Croix
-- **
-- **  Summary  : Main mission flow script for X1CA_Coop_002_v03
-- **
...
local M1LoyalistAI = import('/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_m1loyalistai.lua')
local M2LoyalistAI = import('/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_m2loyalistai.lua')
local M1OrderAI = import('/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_m1orderai.lua')
local M2OrderAI = import('/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_m2orderai.lua')
local M4OrderAI = import('/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_m4orderai.lua')
local M2QAIAI = import('/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_m2qaiai.lua')
local M3QAIAI = import('/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_m3qaiai.lua')
local M4QAIAI = import('/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_m4qaiai.lua')
local Objectives = import('/lua/ScenarioFramework.lua').Objectives
local OpStrings = import('/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_Strings.lua')
...
local ScriptFile = '/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_script.lua'
...
-- Taunt Managers
-- --------------
local CeleneTM = TauntManager.CreateTauntManager('CeleneTM', '/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_Strings.lua')
local CeleneM4TM = TauntManager.CreateTauntManager('CeleneM2TM', '/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_Strings.lua')
local QAITM = TauntManager.CreateTauntManager('QAITM', '/maps/X1CA_Coop_002_v03/X1CA_Coop_002_v03_Strings.lua')
...
function IntroNIS()
	...
	for iArmy, strArmy in pairs(tblArmy) do
		if iArmy >= ScenarioInfo.Coop1 then
			...
			if(factionIdx == 1) then
				ScenarioInfo.CoopCDR[coop] = ScenarioUtils.CreateArmyUnit(strArmy, 'UEF_ACU')
			elseif(factionIdx == 2) then
				ScenarioInfo.CoopCDR[coop] = ScenarioUtils.CreateArmyUnit(strArmy, 'Aeon_ACU')
			else
				ScenarioInfo.CoopCDR[coop] = ScenarioUtils.CreateArmyUnit(strArmy, 'Cybran_ACU')
			end
