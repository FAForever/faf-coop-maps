-- ****************************************************************************
-- **
-- **  File     :  /maps/SCCA_Coop_R05_v01/SCCA_Coop_R05_v01_script.lua
-- **  Author(s):  Greg
-- **
-- **  Summary  :
-- **
...
local OpStrings   = import('/maps/SCCA_Coop_R05_v01/SCCA_Coop_R05_v01_Strings.lua')
...
function KillGame_Fail()
    WaitSeconds(7.0)
    ScenarioFramework.EndOperation('SCCA_Coop_R05_v01', false, ScenarioInfo.Options.Difficulty, false, false )
end
...
function KillGame_Win()
    ...
    ScenarioFramework.EndOperation('SCCA_Coop_R05_v01', true, ScenarioInfo.Options.Difficulty, true, secondaries )
end
...
-- ScenarioFramework.EndOperation('SCCA_Coop_R05_v01', true, ScenarioInfo.Options.Difficulty, true, true )
-- end
--
