-- ****************************************************************************
-- **
-- **  File     :  /maps/SCCA_Coop_A02_v03/SCCA_Coop_A02_v03_operation.lua
...
opID = 'SCCA_Coop_A02_v03'						-- should always be in the form 'SCCA_' + faction letter + 2-digit op num, e.g. SCCA_E01
opLoc = {x = 200, y = 452}			-- location of op 'planet' on op select screen
opDesc = ''							-- used in op select screen

-- DO NOT EDIT
local opVars = import('/lua/ui/campaign/operationvars.lua').MakeOpVars(opID, 'aeon', 2)
