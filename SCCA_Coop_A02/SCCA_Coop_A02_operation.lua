-- ****************************************************************************
-- **
-- **  File     :  /maps/SCCA_Coop_A02/SCCA_Coop_A02_v03_operation.lua
...
opID = 'SCCA_Coop_A02'                        -- should always be in the form 'SCCA_' + faction letter + 2-digit op num, e.g. SCCA_E01
