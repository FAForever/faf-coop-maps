...
function QAIAirBaseAttacks()
    ...
    opai = QAIAirBase:AddOpAI('AirAttacks', 'M3_AirAirAttack13',
        {
            MasterPlatoonFunction = {'/maps/X1CA_Coop_005_v02/X1CA_Coop_005_v02_m3qaiai.lua', 'M3AttackMegalithWaterAI'},
            Priority = 150,
        }
    )
    ...
    opai = QAIAirBase:AddOpAI('AirAttacks', 'M3_AirAirAttack14',
        {
            MasterPlatoonFunction = {'/maps/X1CA_Coop_005_v02/X1CA_Coop_005_v02_m3qaiai.lua', 'M3AttackMegalithLandAI'},
            Priority = 140,
        }
    )
    opai:SetChildQuantity('Gunships', quantity[Difficulty])
    ...
    opai = QAIAirBase:AddOpAI('AirAttacks', 'M3_AirAirAttack15',
        {
            MasterPlatoonFunction = {'/maps/X1CA_Coop_005_v02/X1CA_Coop_005_v02_m3qaiai.lua', 'M3AttackCDRWaterAI'},
            Priority = 150,
        }
    )
    opai:SetChildQuantity('TorpedoBombers', quantity[Difficulty])
    ...
    opai = QAIAirBase:AddOpAI('AirAttacks', 'M3_AirAirAttack16',
        {
            MasterPlatoonFunction = {'/maps/X1CA_Coop_005_v02/X1CA_Coop_005_v02_m3qaiai.lua', 'M3AttackCDRLandAI'},
            Priority = 140,
        }
    )
    opai:SetChildQuantity('Gunships', quantity[Difficulty])
    opai:AddBuildCondition('/maps/X1CA_Coop_005_v02/X1CA_Coop_005_v02_m3qaiai.lua', 'CDROnLand', {})
