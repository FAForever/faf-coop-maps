...
function Seraphimbase1AI()
    ...
    Seraphimbase1:InitializeDifficultyTables(aiBrain, 'P1Seraphimbase1', 'P1serabase1MK', 100, {P1base1 = 700})
...
function P1B1seraLand()
    ...
    Builder = {
        ...
        BuildConditions = {
           ...
           {{'HumanPlayers'}, trigger[Difficulty], (categories.ALLUNITS * categories.MOBILE) - categories.ENGINEER}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
           PatrolChains = {'P1B1SERlandattack1','P1B1SERlandattack2','P1B1SERlandattack3'}
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
           {{'HumanPlayers'}, trigger[Difficulty], categories.STRUCTURE * categories.DEFENSE - categories.WALL}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
           PatrolChains = {'P1B1SERlandattack1','P1B1SERlandattack2','P1B1SERlandattack3'}
...
function P1B1seraAir()
    ...
    Builder = {
       ...
       BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
           {{'HumanPlayers'}, trigger[Difficulty], categories.ALLUNITS - (categories.ENGINEER + categories.TECH1)}},
        },
       PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
       PlatoonData = {
           PatrolChains = {'P1B1SERairattack1','P1B1SERairattack2'}
...
function Seraphimbase2AI()
    ...
    local aiBrain = ArmyBrains[Seraphim]--[[@as CampaignAIBrain]]
    Seraphimbase2:InitializeDifficultyTables(aiBrain, 'P1Seraphimbase2', 'P1serabase2MK', 110, {P1base2 = 700})
...
function P1B2seraAir()
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
           {{'HumanPlayers'}, trigger[Difficulty], categories.ALLUNITS - (categories.ENGINEER + categories.WALL)}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
           {{'HumanPlayers'}, 7, (categories.AIR * categories.MOBILE) - categories.TECH1}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
           PatrolChains = {'P1B2SERairattack1','P1B2SERairattack2', 'P1B2SERairattack3'}
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
           {{'HumanPlayers'}, trigger[Difficulty], categories.AIR * categories.MOBILE * (categories.TECH2 + categories.TECH3)}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
           PatrolChains = {'P1B2SERairattack1','P1B2SERairattack2', 'P1B2SERairattack3'}
...
function P1B2seraLand()
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
           {{'HumanPlayers'}, trigger[Difficulty], categories.AIR * categories.MOBILE * categories.ANTINAVY}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
           PatrolChains = {'P1B2Landattack1','P1B2Landattack2', 'P1B2Landattack3'}
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
           {{'HumanPlayers'}, 10, categories.ALLUNITS * categories.TECH3}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
           PatrolChains = {'P1B2Landattack1','P1B2Landattack2', 'P1B2Landattack3'}
    ...
    Builder = {
        ...
        BuildConditions = {
            ...
            { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
               {{'HumanPlayers'}, trigger[Difficulty], categories.ALLUNITS - categories.ENGINEER}},
        },
...
function P1B2seraNaval()
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
           {{'HumanPlayers'}, trigger[Difficulty], categories.STRUCTURE * categories.NAVAL}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
           {{'HumanPlayers'}, trigger[Difficulty], (categories.NAVAL * categories.MOBILE) + categories.T1SUBMARINE}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
           PatrolChains = {'P1SERnavalattack1','P1SERnavalattack2'}
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
           {{'HumanPlayers'}, trigger[Difficulty], (categories.ALLUNITS * categories.STRUCTURE) - categories.TECH1}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
           PatrolChains = {'P1SERnavalattack1','P1SERnavalattack2'}
...
function SeraphimbaseR1AI()
    ...
    local aiBrain = ArmyBrains[Seraphim]--[[@as CampaignAIBrain]]
    SeraphimbaseR1:InitializeDifficultyTables(aiBrain, 'P1SeraphimbaseR1', 'P1SRandMK', 50, {P1SRand1 = 700})
...
function SeraphimbaseR2AI()
    ...
    local aiBrain = ArmyBrains[Seraphim]--[[@as CampaignAIBrain]]
    SeraphimbaseR2:InitializeDifficultyTables(aiBrain, 'P1SeraphimbaseR2', 'P1SRandMK', 50, {P1SRand2 = 700})
...
function SeraphimbaseR3AI()
    ...
    local aiBrain = ArmyBrains[Seraphim]--[[@as CampaignAIBrain]]
    SeraphimbaseR3:InitializeDifficultyTables(aiBrain, 'P1SeraphimbaseR3', 'P1SRandMK', 50, {P1SRand3 = 700})
