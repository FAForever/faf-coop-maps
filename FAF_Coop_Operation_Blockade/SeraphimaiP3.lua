...
function Seraphimbase1P3AI()
    ...
    Seraphimbase1P3:InitializeDifficultyTables(aiBrain, 'SeraphimB1P3', 'P3B1MK', 140, {P3base1 = 700})
...
function P3B1seraAir()
    ...
    opai:SetLockingStyle('DeathRatio', {Ratio = 0.5})
    opai:AddBuildCondition('/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainsCompareNumCategory',
            {{'HumanPlayers'}, 1, categories.STRUCTURE * categories.EXPERIMENTAL, '>='})
end
...
function P3B1seraNaval()
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
           {{'HumanPlayers'}, 15, categories.NAVAL * categories.MOBILE - categories.ENGINEER}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
           PatrolChains = {'P3B1Navalattack1','P3B1Navalattack2'}
...
function Seraphimbase2P3AI()
    ...
    local aiBrain = ArmyBrains[Seraphim2]--[[@as CampaignAIBrain]]
    Seraphimbase2P3:InitializeDifficultyTables(aiBrain, 'Seraphimbase2P3', 'P3B2MK', 90, {P3base2 = 700})
...
function P3B2seraNaval()
    ...
    Builder = {
        ...
        BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
           {{'HumanPlayers'}, 2, categories.EXPERIMENTAL * categories.NAVAL}},
        },
        PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
        PlatoonData = {
           PatrolChains = {'P3B2Navalattack1','P3B2Navalattack2'}
    ...
    Builder = {
       ...
       BuildConditions = {
           { '/lua/editor/otherarmyunitcountbuildconditions.lua', 'BrainGreaterThanOrEqualNumCategory',
           {{'HumanPlayers'}, 20, categories.AIR * categories.MOBILE}},
        },
       PlatoonAIFunction = {SPAIFileName, 'PatrolChainPickerThread'},     
       PlatoonData = {
           PatrolChains = {'P3B2Navalattack1','P3B2Navalattack2'}
...
function Seraphimbase3P3AI()
    ...
    local aiBrain = ArmyBrains[Seraphim2]--[[@as CampaignAIBrain]]
    Seraphimbase3P3:InitializeDifficultyTables(aiBrain, 'Seraphimbase3P3', 'P3B3MK', 90, {P3base3 = 700})
...
function Seraphimbase4P3AI()
    ...
    local aiBrain = ArmyBrains[Seraphim2]--[[@as CampaignAIBrain]]
    Seraphimbase4P3:InitializeDifficultyTables(aiBrain, 'SeraphimB4P3', 'P3B4MK', 90, {P3base4 = 700})
