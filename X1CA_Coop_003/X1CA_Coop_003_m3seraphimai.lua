-- ****************************************************************************
-- **
-- **  File     : /maps/X1CA_Coop_003/X1CA_Coop_003_m3seraphimai.lua
...
function SeraphimM3SouthBaseAI()
    ...
    SeraphimM3SouthBase:InitializeDifficultyTables(aiBrain, 'M3_Seraph_South', 'M3_Seraph_South', 150, {M3_Seraph_South = 100})
