    ...
    opai = M1RhizaBase:AddOpAI('Colossus_1',
        {
            Amount = 1,
            KeepAlive = true,
            PlatoonAIFunction = {'/maps/X1CA_Coop_003_v02/X1CA_Coop_003_v02_script.lua', 'ColossusPing'},
            MaxAssist = 5,
            Retry = true,
...
function M1RhizaBaseLandAttacks()
	...
	local builder = {
        ...
        RequiresConstruction = true,
        LocationType = 'M1_Rhiza_Base',
		PlatoonAIFunction = {'/maps/X1CA_Coop_003_v02/X1CA_Coop_003_v02_m1rhizaai.lua', 'M1RhizaAirAttackAI'},
    }
    ...
    for i = 1, 6 do
        opai = M1RhizaBase:AddOpAI('BasicLandAttack', 'Rhiza_AmphibiousDefense_' .. i,
            {
                MasterPlatoonFunction = {'/maps/X1CA_Coop_003_v02/X1CA_Coop_003_v02_m1rhizaai.lua', 'RhizaNavalDEFENSEAI'},
                Priority = 110,
            }
        )
...
function M1RhizaBaseNavalAttacks()
	...
	local builder = {
        ...
        RequiresConstruction = true,
        LocationType = 'M1_Rhiza_Base',
		PlatoonAIFunction = {'/maps/X1CA_Coop_003_v02/X1CA_Coop_003_v02_m1rhizaai.lua', 'RhizaNavalDEFENSEAI'},
    }
    ArmyBrains[Rhiza]:PBMAddPlatoon( builder )
    ...
    opai = M1RhizaBase:AddOpAI('Colossus_2',
        {
            Amount = 1,
            KeepAlive = true,
            PlatoonAIFunction = {'/maps/X1CA_Coop_003_v02/X1CA_Coop_003_v02_m1rhizaai.lua', 'Colossus2AI'},
            MaxAssist = 5,
            Retry = true,
        }
    )
