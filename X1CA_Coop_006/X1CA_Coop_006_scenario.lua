...
ScenarioInfo = {
    ...
    version = 1,
    size = {1024, 1024},
    map = '/maps/X1CA_Coop_006/X1CA_Coop_006_v02.scmap',
    save = '/maps/X1CA_Coop_006/X1CA_Coop_006_v02_save.lua',
    script = '/maps/X1CA_Coop_006/X1CA_Coop_006_v02_script.lua',
