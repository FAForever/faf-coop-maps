version = 3
ScenarioInfo = {
    name = 'FA Campaign Mission 6 - Coop',
    description = '',
    type = 'campaign_coop',
    starts = true,
    preview = '',
    version = 1,
    size = {1024, 1024},
    map = '/maps/X1CA_Coop_006_v02/X1CA_Coop_006_v02.scmap',
    save = '/maps/X1CA_Coop_006_v02/X1CA_Coop_006_v02_save.lua',
    script = '/maps/X1CA_Coop_006_v02/X1CA_Coop_006_v02_script.lua',
    ...
    Configurations = {
        ['standard'] = {
            teams = {
                { name = 'FFA', armies = {'Player','Rhiza','Fletcher','Order','Seraphim','ControlCenter','OptionZero','Coop1','Coop2','Coop3'} },
            },
            customprops = {
            },
        },
