...
function QAIP3base1AI()
    ...
    QAIP3base1:InitializeDifficultyTables(aiBrain, 'QAIP3base1', 'QAIP3base1MK', 80, {P3Qbase1 = 100})
...
function QAIP3base2AI()
    ...
    local aiBrain = ArmyBrains[QAI]--[[@as CampaignAIBrain]]
    QAIP3base2:InitializeDifficultyTables(aiBrain, 'QAIP3base2', 'QAIP3base2MK', 80, {P3Qbase2 = 100})
...
function QAIP3base3AI()
    ...
    local aiBrain = ArmyBrains[QAI]--[[@as CampaignAIBrain]]
    QAIP3base3:InitializeDifficultyTables(aiBrain, 'QAIP3base3', 'QAIP3base3MK', 80, {P3Qbase3 = 100})
